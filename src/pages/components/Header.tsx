            ...
            <nav className="bg-white border-gray-200 border-b px-4 lg:px-6 py-2.5 ">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    <Link to="/" className="flex items-center">
                        <img src="https://www.svgrepo.com/show/225210/earth-globe-earth.svg" className="mr-3 h-6 sm:h-9" alt="quizly Logo" />
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        {user.username && (
                            <>
                               <h3 className='text-xl text-gray-800 hidden md:block pr-5 font-semibold'>Hi {user.username}</h3>
                                ...
                                <Link to="/logout" className="flex items-center">
                                    <img src="https://www.svgrepo.com/show/485527/logout-circle.svg" className="mr-3 h-9 sm:h-9" alt="logout" />
                                </ Link>
                            </>
                        )}
